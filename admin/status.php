...
function iframeResize() {
    var iFrameID = document.getElementById(\'sprod_integr_status_frame\');
    if (iFrameID) {
        var cont_h = (iFrameID.contentWindow.document.body.scrollHeight + 30) + \'px\';
        $(\'#sprod_integr_status_frame\').height(cont_h);
    }
}
</script>');
...
?>
    <iframe src="sprod_integr_status_page.php" class="sprod-integr-frame" id="sprod_integr_status_frame"></iframe>
<?
