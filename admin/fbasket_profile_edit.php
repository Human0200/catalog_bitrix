...
$APPLICATION->SetTitle(Loc::getMessage('SP_CI_FBASKET_TITLE'));
...
function iframeResize() {
    var iFrameID = document.getElementById(\'sprod_integr_fbasket_profile_edit_frame\');
    if (iFrameID) {
        var cont_h = (iFrameID.contentWindow.document.body.scrollHeight + 30);
        $(\'#sprod_integr_fbasket_profile_edit_frame\').height(cont_h + \'px\');
    }
}
</script>');
...
?>
    <iframe src="sprod_integr_fbasket_profile_edit_page.php?id=<?=$profile_id;?>" class="sprod-integr-frame" id="sprod_integr_fbasket_profile_edit_frame"></iframe>
<?
