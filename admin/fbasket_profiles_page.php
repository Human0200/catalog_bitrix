...
$scripts = ['/bitrix/js/'.$MODULE_ID.'/page_fbasket_profiles.js'];
$styles = [];
...
?>
    ...
    <div id="app">
        <div class="sprod-integr-page" id="sprod_integr_fbasket_profiles_page">
            <div class="wrapper iframe-wrapper">
                <div class="container-fluid pl-3 pr-3">

                    <div class="page-title-box">
                        <loader :counter="loader_counter"></loader>
                        <h4 class="page-title"><?=Loc::getMessage('SP_CI_FBASKET_PROFILES_TITLE');?></h4>
                    </div>
